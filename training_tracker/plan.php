    ...
    try {
        ...
        document.getElementById('cancelBtn').addEventListener('click', function() {
            ...
            document.getElementById('timerContainer').style.display = 'none';
                ...
                // Προσθήκη λειτουργικότητας για το κουμπί παύσης
                document.getElementById('pauseBtn').addEventListener('click', function() {
                    isPaused = !isPaused; // Αλλάζει την κατάσταση (από true σε false και αντίστροφα)
                    
                    // Αλλάζει το κείμενο του κουμπιού ανάλογα με την κατάσταση
                    this.textContent = isPaused ? '▶️ Συνέχεια' : '⏸️ Παύση';
                    
                    // Προαιρετικό: Αλλάζει το χρώμα για καλύτερη ανατροφοδότηση
                    this.style.backgroundColor = isPaused ? '#4CAF50' : '#FF9800';
                });
